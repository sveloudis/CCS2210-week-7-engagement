...
<?php
	...
	// Use the above four variables and the mysqli_connect function to create a connection to the Hogwarts database. The connection should be named $con.
	...
	// The following is hust an output message to display which table was selected.
